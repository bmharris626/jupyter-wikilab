...
An extension for displaying/editing wikis within jupyterhub workspace

This extension is composed of a Python package named `jupyterhub_wikilab`
for the server extension and a NPM package named `jupyterhub-wikilab`
...
```bash
pip install jupyterhub_wikilab
```
...
# Change directory to the jupyterhub_wikilab directory
...
folder is located. Then you can remove the symlink named `jupyterhub-wikilab` within that folder.
