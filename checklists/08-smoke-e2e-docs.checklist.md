...
- [x] **Run install/develop workflow**
...
- [x] **Validate create-and-commit page flow**
...
- [x] **Validate wiki-links and backlinks behavior**
...
- [x] **Validate stale-write conflict behavior**
...
- [x] **Validate `_sidebar.md` ordering behavior**
...
- [x] **Validate full-text search output**
...
- [x] **Validate page history and rename flow**
...
- [x] **Add user quickstart documentation**
