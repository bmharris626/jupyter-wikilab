...
- [x] **Define TypeScript API contracts**
...
- [x] **Implement `wikiApi.ts` typed REST wrapper**
  - **Task:** Add methods for all backend endpoints via `ServerConnection`.
  - **Validation:** `jlpm tsc --noEmit` (all exports fully typed)
  - **Commit suggestion:** `feat(frontend): implement typed wiki API client`

- [x] **Implement markdown-it base renderer**
...
- [x] **Add renderer unit tests for edge cases**
