...
- [x] **Define plugin token in `tokens.ts`**
...
- [x] **Wire extension activation in `index.ts`**
...
- [x] **Register commands for wiki actions**
...
- [x] **Register sidebar and main-area integration**
...
- [x] **Define settings schema fields**
