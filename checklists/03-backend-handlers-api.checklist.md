...
- [ ] **Register extension routes under `/wikilab/api/`**
...
- [ ] **Add per-wiki asyncio lock for write operations**
...
- [ ] **Implement stale-write conflict detection**
